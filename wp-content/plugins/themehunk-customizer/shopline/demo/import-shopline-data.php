...
function shopline_import_files(){
 return array(  
    array(
        'import_file_name' => esc_html__('Shopline Default','shopline'),
        'import_file_url'=> THEMEHUNK_CUSTOMIZER_PLUGIN_URL .'shopline/demo/import-file/shopline.WordPress.2019-08-16.xml',
        'import_customizer_file_url'=> THEMEHUNK_CUSTOMIZER_PLUGIN_URL .'shopline/demo/import-file/shopline-export.dat',
        'import_widget_file_url'=> THEMEHUNK_CUSTOMIZER_PLUGIN_URL .'shopline/demo/import-file/themehunk.com-wp-themes-shopline-widgets.wie',
        'import_preview_image_url'=> esc_url(THEMEHUNK_CUSTOMIZER_PLUGIN_URL . 'shopline/demo/images/shopline-default.png' ),
        'preview_url'=> '',
